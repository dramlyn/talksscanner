...
public class Topic {
    ...
    public Topic(long id, String title, String author, String description, String tags, LocalDateTime eventDate, String presentationLink, String videoLink, TopicStatus status, User user) {
        this.id = id;
        this.title = title;
        this.author = author;
