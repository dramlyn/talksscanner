...
public class TopicController {
    ...
    @GetMapping
    public Page<TopicDtoResponse> getAllIdeas(@AuthenticationPrincipal UserDetails userDetails, Pageable pageable, GetAllTopicsParamRequest request) throws ServiceException {
