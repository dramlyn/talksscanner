...
public class FilterMapper {
    ...
    public List<Filter> convertToFilters(GetAllTopicsParamRequest request) {
        ...
        if (request.getTags() != null) {
            LOGGER.debug("get {} Filter from GetAllTopicsParamRequest.tags : {}", QueryOperator.STARTS_WITH_IGNORE_CASE, request.getTags());
            filters.add(new Filter("tags", QueryOperator.STARTS_WITH_IGNORE_CASE, request.getTags()));
        }
