...
public class IdeaDtoResponse implements Serializable {
    ...
    public IdeaDtoResponse(Long id, String title, String description, UserSimpleDtoResponse user, LocalDateTime creationDate, LocalDateTime lastUpdateDate, IdeaStatus status) {
        this.id = id;
        this.title = title;
