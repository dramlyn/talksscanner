...
public class TopicServiceTest {
    ...
    public void testInsertUserTopic(){
        ...
        TopicDtoResponse expected = new TopicDtoResponse(1, "title", "author", "description",
                null, null, null, null, TopicStatus.ANNOUNCED, user.getId());
    ...
    public void testUpdateUserTopic() throws ServiceException {
        ...
        TopicDtoResponse expected = new TopicDtoResponse(1, "new_title", "author", "new_desc", null, null, null, null, TopicStatus.ANNOUNCED, 1);
