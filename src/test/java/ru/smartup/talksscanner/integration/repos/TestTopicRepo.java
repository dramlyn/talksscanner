...
public class TestTopicRepo {
    ...
    public void set_up() {
        ...
        topicRepo.saveAll(List.of(
                new Topic(1L, "title",  user.getLastname() + " " + user.getFirstname(), "description","java", null, null, null, TopicStatus.ANNOUNCED, user),
                new Topic(2L, "title",  user.getLastname() + " " + user.getFirstname(), "description","java", null, null, null, TopicStatus.ANNOUNCED, user),
                new Topic(3L, "title",  user.getLastname() + " " + user.getFirstname(), "description","FrOnt", null, null, null, TopicStatus.BEING_PREPARED, user),
                new Topic(4L, "uTitle", user.getLastname() + " " + user.getFirstname(), "description","front", null, null, null, TopicStatus.ANNOUNCED, user),
                new Topic(5L, "uTitle", user.getLastname() + " " + user.getFirstname(), "description","mobx", null, null, null, TopicStatus.DONE, user),
                new Topic(6L, "uTitle", user.getLastname() + " " + user.getFirstname(), "description","go", null, null, null, TopicStatus.SCHEDULED, user),
                new Topic(7L, "uTitle", user.getLastname() + " " + user.getFirstname(), "description","ts", null, null, null, TopicStatus.DONE, user),
                new Topic(8L, "Title",  user.getLastname() + " " + user.getFirstname(), "description","mysql", null, null, null, TopicStatus.SCHEDULED, user)
        ));
