...
public class TopicTestData {
    ...
    {
        return new TopicDtoResponse(id, title, author, description, tags, eventDate, presentationLink, videoLink, status, userID);
    }
    ...
    public static Topic makeTopic (long id, String title, String author, String description, String
        ...
        return new Topic(id, title, author, description, tags, eventDate, presentationLink, videoLink, status, user);
    }
